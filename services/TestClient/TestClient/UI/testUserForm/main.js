...
const _c0 = ["camundaform"];
// declare var CamSDK: any;
class AppComponent {
    constructor(activatedRoute) {
        this.activatedRoute = activatedRoute;
        this.title = 'testUserForm';
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], viewQuery: function AppComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, decls: 12, vars: 0, consts: [["role", "form", "name", "testForm"], ["camundaform", ""], [1, "form-group"], ["for", "customerId-field"], ["required", "", "cam-variable-name", "customerId", "cam-variable-type", "String", 1, "form-control"], ["for", "amount-field"], ["cam-variable-name", "amount", "cam-variable-type", "Double", 1, "form-control"], ["src", "../assets/testimage.png"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AppComponent, [{
    ...
    }], function () { return [{ type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"] }]; }, { myForm: [{
            type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"],
            args: ['camundaform', { static: true }]
        }] }); })();
...
module.exports = __webpack_require__(/*! D:\dev\camunda\Forms\testUserForm\src\main.ts */"./src/main.ts");
